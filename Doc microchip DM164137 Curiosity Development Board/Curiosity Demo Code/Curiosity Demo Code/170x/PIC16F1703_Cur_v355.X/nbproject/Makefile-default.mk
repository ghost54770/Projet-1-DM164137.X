...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Labs/Lab01_HelloWorld/HelloWorld.c Labs/Lab02_Blink/Blink.c Labs/Lab03_Rotate/Rotate.c Labs/Lab04_AnalogToDigitalConversion/ADC.c Labs/Lab05_VariableSpeedRotate/VSR.c Labs/Lab06_PulseWidthModulation/PWM.c Labs/Lab07_Timers/Timer1.c Labs/Lab08_Interrupts/Interrupt.c Labs/Lab09_SleepWakeup/SleepWakeUp.c Labs/Lab10_HighEnduranceFlash/HEF.c mcc_generated_files/tmr0.c mcc_generated_files/pin_manager.c mcc_generated_files/tmr2.c mcc_generated_files/mcc.c mcc_generated_files/device_config.c mcc_generated_files/tmr1.c mcc_generated_files/adc.c mcc_generated_files/interrupt_manager.c mcc_generated_files/memory.c mcc_generated_files/pwm1.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Labs/Lab01_HelloWorld/HelloWorld.p1 ${OBJECTDIR}/Labs/Lab02_Blink/Blink.p1 ${OBJECTDIR}/Labs/Lab03_Rotate/Rotate.p1 ${OBJECTDIR}/Labs/Lab04_AnalogToDigitalConversion/ADC.p1 ${OBJECTDIR}/Labs/Lab05_VariableSpeedRotate/VSR.p1 ${OBJECTDIR}/Labs/Lab06_PulseWidthModulation/PWM.p1 ${OBJECTDIR}/Labs/Lab07_Timers/Timer1.p1 ${OBJECTDIR}/Labs/Lab08_Interrupts/Interrupt.p1 ${OBJECTDIR}/Labs/Lab09_SleepWakeup/SleepWakeUp.p1 ${OBJECTDIR}/Labs/Lab10_HighEnduranceFlash/HEF.p1 ${OBJECTDIR}/mcc_generated_files/tmr0.p1 ${OBJECTDIR}/mcc_generated_files/pin_manager.p1 ${OBJECTDIR}/mcc_generated_files/tmr2.p1 ${OBJECTDIR}/mcc_generated_files/mcc.p1 ${OBJECTDIR}/mcc_generated_files/device_config.p1 ${OBJECTDIR}/mcc_generated_files/tmr1.p1 ${OBJECTDIR}/mcc_generated_files/adc.p1 ${OBJECTDIR}/mcc_generated_files/interrupt_manager.p1 ${OBJECTDIR}/mcc_generated_files/memory.p1 ${OBJECTDIR}/mcc_generated_files/pwm1.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Labs/Lab01_HelloWorld/HelloWorld.p1.d ${OBJECTDIR}/Labs/Lab02_Blink/Blink.p1.d ${OBJECTDIR}/Labs/Lab03_Rotate/Rotate.p1.d ${OBJECTDIR}/Labs/Lab04_AnalogToDigitalConversion/ADC.p1.d ${OBJECTDIR}/Labs/Lab05_VariableSpeedRotate/VSR.p1.d ${OBJECTDIR}/Labs/Lab06_PulseWidthModulation/PWM.p1.d ${OBJECTDIR}/Labs/Lab07_Timers/Timer1.p1.d ${OBJECTDIR}/Labs/Lab08_Interrupts/Interrupt.p1.d ${OBJECTDIR}/Labs/Lab09_SleepWakeup/SleepWakeUp.p1.d ${OBJECTDIR}/Labs/Lab10_HighEnduranceFlash/HEF.p1.d ${OBJECTDIR}/mcc_generated_files/tmr0.p1.d ${OBJECTDIR}/mcc_generated_files/pin_manager.p1.d ${OBJECTDIR}/mcc_generated_files/tmr2.p1.d ${OBJECTDIR}/mcc_generated_files/mcc.p1.d ${OBJECTDIR}/mcc_generated_files/device_config.p1.d ${OBJECTDIR}/mcc_generated_files/tmr1.p1.d ${OBJECTDIR}/mcc_generated_files/adc.p1.d ${OBJECTDIR}/mcc_generated_files/interrupt_manager.p1.d ${OBJECTDIR}/mcc_generated_files/memory.p1.d ${OBJECTDIR}/mcc_generated_files/pwm1.p1.d ${OBJECTDIR}/main.p1.d
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,-asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=+asm,-asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/PIC16F1703_Cur_v355.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
